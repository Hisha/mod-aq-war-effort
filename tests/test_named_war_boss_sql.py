...
add(schema)
check('SELECT COUNT(*)=2 FROM aq_war_effort_boss_kill', 'rerunnable schema preserves history')
...
check('SELECT COUNT(*)=3 FROM aq_war_effort_boss_kill', 'new epoch preserves old deaths')
